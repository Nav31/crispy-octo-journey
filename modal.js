...
var modal = '<div id="myModal" class="modal"><div class="modal-content"><p>Write Something Here:</p><textarea rows="4" cols="50"></textarea><button id="post" class="btn btn-primary-outline">Post</button></div></div>';
