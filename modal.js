...
var modal = '<div id="myModal" class="modal"><div class="modal-content"><h3>Write a Comment:</h3><textarea rows="4" cols="50"></textarea><button class="btn btn-success" id="postIt">POST</button><button class="btn btn-success" id="closeIt">CLOSE</button></div></div>';
