...
var modal = '<div id="myModal" class="modal"><div class="modal-content"><p>write a comment:</p><textarea rows="4" cols="50"></textarea><button class="btn btn-success" id="postIt">POST</button></div></div>';
